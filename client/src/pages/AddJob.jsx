  ...
  return (
    <form className='container p-4 flex flex-col items-start w-full gap-3'>
      ...
      <div className='w-full max-w-lg'>
        ...
        <div ref={editorRef}>{/* quill  */}</div>
      </div>

      <div className='flex flex-col sm:flex-row w-full sm:gap-8 gap-2'>
      ...
      <div>
        ...
        type="number" onChange={(e) => setSalary(e.target.value)} placeholder='2500'min={0}/>
      </div>

      <button className='w-28 bg-black text-white py-3 mt-4 cursor-pointer rounded'>ADD</button>
